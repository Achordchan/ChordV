...
assert.doesNotMatch(app,/runtimeMirrorPrefix|setRuntimeMirrorPrefix/);
assert.doesNotMatch(hook,/options\.runtimeMirrorPrefix/);
const runtimeHook = readFileSync(new URL("../src/hooks/useRuntimeAssets.ts",import.meta.url),"utf8");
assert.doesNotMatch(runtimeHook,/runtimeMirrorPrefix|mirrorPrefixStorageKey/);
