...
export type ComponentVersion = { retainUntil?:string|null; id: string; versionLabel: string | null; requestedVersion: string | null; status: string; bytesReceived: string; fileSizeBytes: string | null; lastError: string | null; createdAt: string; fileHash: string | null; publishedAt: string | null; sourceUrl: string; resolvedUrl: string | null };
...
export const acquireComponent = (input: { componentId: string; sourceUrl: string; version?: string; autoLatest: boolean }) => request<{id:string;reused?:boolean}>("/admin/runtime-versions/acquire", { method: "POST", body: JSON.stringify(input) });
